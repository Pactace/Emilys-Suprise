extends Resource
class_name BathroomWallInventory

@export var objects := {
	"res://Models/Final Models/Bathrooms/FtrTowelrackWall/Textures/FtrTowelrackWall_icon.png": "res://Models/Final Models/Bathrooms/FtrTowelrackWall/FtrTowelrackWall.tscn",
