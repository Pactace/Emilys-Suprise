...
GAMEDIR=/$directory/ports/Test2
godot_runtime="godot_4.4" #match runtime to the Godot version you are using
godot_executable="godot44.$DEVICE_ARCH" #match runtime to the Godot versio
pck_filename="ArbernicTest2.pck"
gptk_filename="ArbernicTest2.gptk"
